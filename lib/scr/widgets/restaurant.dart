...
class _RestaurantWidgetState extends State<RestaurantWidget> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Stack(
        children: <Widget>[
          _backgroundImage(widget.restaurant.sImage),
          Padding(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Text(widget.restaurant.iRating.toString()),
                      ],
                    ),
                  ),
                ),
                ...
                Padding(
                  ...
                  child: RichText(
                    text: TextSpan(children: [
                      ...
                      TextSpan(
                          text: "\$${widget.restaurant.iAvgPrice} \n",
              ...
              children: <Widget>[
                ...
                Center(
                  child: CachedNetworkImage(
                      ...
                      imageUrl: widget.restaurant.sImage),
                )
              ],
            )),
      );
